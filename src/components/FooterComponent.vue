...
<template>
  <footer class="footer border-top-gradient p-7 flex flex-col justify-center items-center space-y-5">
    ...
    <div class="creds text-center text-sm">
      <p>Designed by <a href="https://www.linkedin.com/in/kuete-cyrille" class="link font-bold mx-1" target="_blank">Kuete Cyrille</a> & coded by <a href="https://github.com/fredchess/portfolio-frontend" class="link font-bold mx-1" target="_blank">Frederick Essono</a></p>
    </div>
  </footer>
</template>
