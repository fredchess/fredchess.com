...
<template>
  <section class="intro flex flex-col items-start justify-center space-y-2">
    <div class="relative">
      ...
      >
      <h2
        class="text-5xl md:text-7xl font-bold text-important"
        v-motion
        :initial="{ opacity: 0 }"
        :enter="{ opacity: 1 }"
        :delay="1700 * 1.05"
      ...
      >
        ...
        possible.</span
      >
      <a href="https://drive.google.com/file/d/1lAtjlM0fBJE9B6gZUn930p5h11r3U3hW/view?usp=sharing" target="_blank">
        <button
